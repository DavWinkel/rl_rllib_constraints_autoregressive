...
from risk_postprocessing import compute_constraint_penalized_rewards_ipo_merged, calculate_risk_logic
...
class RiskIPOMergedPPOTorchPolicy(
    ValueNetworkMixin,
    LearningRateSchedule,
    EntropyCoeffSchedule,
    KLCoeffMixin,
    ...
    def postprocess_trajectory(
        ...
        with torch.no_grad():
            ...
            sample_batch = compute_constraint_penalized_rewards_ipo_merged(self, sample_batch, other_agent_batches, episode)
