...
class PPOConfig(AlgorithmConfig):
    ...
    def __init__(self, algo_class=None):
        ...
        super().__init__(algo_class=algo_class or RiskIPOMergedPPO)
        ...
        self.t_weight = 1
        # Custom keys
        self.evaluation_amount_episodes = 100
        self.evaluation_allow_backtesting = False
...
class RiskIPOMergedPPO(Algorithm):
    # The merged IPO sums the penalty variables up and only then applies the log which proves to be more stable during training
    ...
    def get_default_policy_class(self, config: AlgorithmConfigDict) -> Type[Policy]:
        if config["framework"] == "torch":
            ...
            from risk_ipo_ppo_policy_merged import RiskIPOMergedPPOTorchPolicy

            return RiskIPOMergedPPOTorchPolicy
