...
class PPOConfig(AlgorithmConfig):
    ...
    def __init__(self, algo_class=None):
        ...
        super().__init__(algo_class=algo_class or Baseline)
        ...
        # Custom
        #self.model["cost_vf_share_layers"] = False
        # Custom keys
...
class Baseline(Algorithm):
    ...
    def get_default_policy_class(self, config: AlgorithmConfigDict) -> Type[Policy]:
        if config["framework"] == "torch":
            ...
            from risk_baseline_policy import RiskBaselinePolicy
            return RiskBaselinePolicy
            #from risk_P3O_ppo_policy import RiskP3OPPOTorchPolicy
            #return RiskP3OPPOTorchPolicy
